          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg sm:text-xl text-pepper-muted max-w-xl leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
                Unfiltered reviews, pure fire insights, and real rewards. Drop the hottest takes and climb the ranks—our <span className="text-white font-black">Top 3 Critics win big every 2 months.</span> If it’s not hot, it’s not here.
              </p>
            </div>
